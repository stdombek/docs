...
*   **Vendor.** Vendor name.
*   **Address 1.** Vendor address 1. This is the vendor’s primary address from the Organization app.  See [Organizations> Adding an address](../acquisitions/organizations/#searching-for-an-organization) for more information.
